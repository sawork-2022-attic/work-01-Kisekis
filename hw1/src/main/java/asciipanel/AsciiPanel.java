...
public class AsciiPanel extends JPanel{
     ...
     */
    @Autowired
    public AsciiPanel(@Value("${width}")int width,
                      @Value("${height}")int height, AsciiFont font) {
        super();
    ...
    private void loadGlyphs() {
        ...
        for (int i = 0; i < BLEN*BLEN; i++) {
            int sx = (i % BLEN) * charWidth;
            int sy = (i / BLEN) * charHeight;
...
//        short[] a = new short[BLEN*BLEN];
//        short[] r = new short[BLEN*BLEN];
//        short[] g = new short[BLEN*BLEN];
//        short[] b = new short[BLEN*BLEN];
//
...
//    }
    ...
    /**
     * Clear the entire rougelike.screen to whatever the default background color is.
     * 
    ...
    /**
     * Clear the entire rougelike.screen with the specified character and whatever the default
    ...
    /**
     * Clear the entire rougelike.screen with the specified character and whatever the
    ...
    /**
     * Clear the section of the rougelike.screen with the specified character and whatever the
